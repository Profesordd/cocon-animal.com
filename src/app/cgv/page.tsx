...
export const metadata = { title: "CGV — Cocon Animal" };
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
        {[
          ["1. Prix", "Tous les prix sont en euros TTC. Cocon Animal se réserve le droit de modifier ses prix à tout moment, mais les produits seront facturés au prix en vigueur lors de la validation de la commande."],
          ...
          ["5. Garantie satisfait", "Cocon Animal offre une garantie satisfait ou remboursé de 30 jours. Contactez-nous à contact@cocon-animal.com."],
          ["6. Service client", "Notre service client est disponible 7j/7 à l'adresse contact@cocon-animal.com."],
        ].map(([title, text]) => (
          <section key={title}>
